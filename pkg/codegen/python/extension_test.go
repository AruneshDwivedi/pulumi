...
// schema generates a Python SDK whose get_package() registers an extension.
func TestExtensionParameterizationCodegen(t *testing.T) {
	...
	assert.Contains(t, utilities, "parameterization=parameterization",
		"an extension SDK's get_package() should register a Parameterization")
	assert.Contains(t, utilities, `kind="extension"`,
