...
var (
	...
	// ErrConfigConflict is returned by UpdateEnvironmentWithProject when the update is rejected because
	// the environment was modified since the etag was read, so the caller can offer a retry.
