...
// TestJournalExtensionParameterize verifies that ExtensionParameterizeStep
// emits a JournalEntryExtensionParameterize with the ref and blob. Without
// this, a cancelled deployment would leave extension-parameterized resources
// in state with no corresponding blob in the replayed snapshot.
