...
type RegisterPackageRequest struct {
	...
	Parameterization *Parameterization      `protobuf:"bytes,5,opt,name=parameterization,proto3" json:"parameterization,omitempty"`                                                             // the optional replacement parameterization for this package.
